...
const getNotificationIcon = (type: string) => {
  switch (type) {
    case "LIKE":
      return <LucideHeart className="size-4 text-red-500" />;
    case "COMMENT":
      return <LucideMessageCircle className="size-4 text-blue-500" />;
    case "FOLLOW":
      return <LucideUserPlus className="size-4 text-green-500" />;
    default:
      return null;
  }
};
